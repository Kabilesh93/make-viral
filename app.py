...
from src.get_data.get_data import *
from src.image_relavance.measure_image_relavance import *
from src.preprocess.emotion_extraction import *
from src.preprocess.preprocess import *
from src.preprocess.preprocess_tweet import preprocess_tweet
from src.suggest_improvements.get_synonyms import *
from src.suggest_improvements.improve_sentiment import *
from src.suggest_improvements.predict_count_for_syns import *
from src.train_and_predict.measure_performance import *
from src.train_and_predict.predict_counts import *
from src.train_and_predict.train_random_forest_regressor import *
...
def preprocess():
    ...
    prepared_data = prepareData(full_corpus)
    preprocess_data(prepared_data)
    return '0'
...
def predict_initial():
    ...
    has_hashtag = int(tweet_preprocessed.loc[0]['hasHashtag'])
    has_media = int(tweet_preprocessed.loc[0]['hasMedia'])
    ...
    return jsonify(initial_retweets=retweets, initial_favorites=favorites, initial_popularity=initial_popularity,
                   hasHashtag=has_hashtag, hasMedia=has_media, emojis=emojis, pos_tag=pos_tag)
...
def improve_tweet():
    ...
    #
    sent_improved_with_syns = get_syns_for_neg_words(positive_words, negative_words, keywords, best_synonyms_list_kw)

    best_synonyms_list_s, max_reach_s, retweet_count_s, favorite_count_s = \
        reach_prediction_forSyns(dataset, x_test_rt, x_test_fv, sent_improved_with_syns, initial_retweet_count, initial_favourite_count)
